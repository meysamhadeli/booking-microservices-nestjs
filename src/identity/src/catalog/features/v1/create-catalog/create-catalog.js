...
const catalog_contracts_1 = require("building-blocks/src/contracts/catalog.contracts");
...
let CatalogController = class CatalogController {
    ...
    CreateCatalogAsync(createCatalogDto) {
        return __awaiter(this, void 0, void 0, function* () {
...
let CreateCatalogHandler = class CreateCatalogHandler {
    ...
    execute(command) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const catalogEntity = yield this.catalogRepository.save(catalog);
            yield this.rabbitmqPublisher.publishMessage(new catalog_contracts_1.CatalogCreated({
