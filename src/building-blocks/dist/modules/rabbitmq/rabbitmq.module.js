...
exports.RabbitmqModule = RabbitmqModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [rabbitmq_connection_1.RabbitmqConnection, rabbitmq_publisher_1.RabbitmqPublisher],
        exports: [rabbitmq_publisher_1.RabbitmqPublisher, rabbitmq_connection_1.RabbitmqConnection]
    })
], RabbitmqModule);
