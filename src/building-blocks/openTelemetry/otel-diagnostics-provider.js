...
class OtelDiagnosticsProvider {
    ...
    getTracer() {
        return api_2.default.trace.getTracer(configs_1.default.opentelemetry.serviceName, configs_1.default.opentelemetry.serviceVersion ?? '1.0.0');
    }
    getMeter() {
        return api_2.default.metrics.getMeter(configs_1.default.opentelemetry.serviceName, configs_1.default.opentelemetry.serviceVersion ?? '1.0.0');
    }
    getLogger() {
    ...
    getCurrentSpan() {
        return api_2.default.trace.getActiveSpan();
    }
    getSpanFromContext(ctx) {
        return api_2.default.trace.getSpan(ctx);
    }
}
