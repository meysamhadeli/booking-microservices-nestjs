...
const openTelemetryTracer_1 = require("./openTelemetryTracer");
...
exports.OpenTelemetryModule = OpenTelemetryModule = __decorate([
    (0, common_1.Module)({
        providers: [openTelemetryTracer_1.OpenTelemetryTracer],
        exports: [openTelemetryTracer_1.OpenTelemetryTracer],
    })
], OpenTelemetryModule);
