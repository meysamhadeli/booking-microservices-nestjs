...
let RequestDurationMiddleware = class RequestDurationMiddleware {
    ...
    use(req, res, next) {
        ...
        res.on('finish', () => {
            ...
            this.requestDurationHistogram.observe(labels, duration / 1000);
        });
        next();
    }
...
exports.RequestDurationMiddleware = RequestDurationMiddleware = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], RequestDurationMiddleware);
//# sourceMappingURL=requestDurationMiddleware.js.map